...
;; Validates and manages hospitality revenue managers
...
(define-map manager-details principal {
    ...
    hotel-id: (string-ascii 20),
    verification-date: uint
})

;; Public functions
(define-public (verify-manager (manager principal) (name (string-ascii 50)) (hotel-id (string-ascii 20)))
    (begin
